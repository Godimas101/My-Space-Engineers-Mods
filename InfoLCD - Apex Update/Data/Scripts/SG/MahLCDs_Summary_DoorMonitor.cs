...
namespace MahrianeIndustries.LCDInfo
{
    ...
    public class LCDDoorMonitorSummary : MyTextSurfaceScriptBase
    {
        ...
        void CreateConfig()
        {
            ...
            config.Set(CONFIG_SECTION_ID, "CompactMode",        $"{compactMode}");
        ...
        void LoadConfig()
        {
            try
            {
                ...
                if (config.TryParse(myTerminalBlock.CustomData, CONFIG_SECTION_ID, out result))
                {
                    ...
                    if (config.ContainsKey(CONFIG_SECTION_ID, "CompactMode"))
                        compactMode = config.Get(CONFIG_SECTION_ID, "CompactMode").ToBoolean();
                    else
                        configError = true;
