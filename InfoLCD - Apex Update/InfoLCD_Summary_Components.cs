    ...
    public class LCDComponentsSummaryInfo : MyTextSurfaceScriptBase
    {
        ...
        void LoadConfig()
        {
            try
            {
                ...
                {
                    MyLog.Default.WriteLine($"SG.LCDInfo.LCDComponentsSummaryInfo: Config Syntax error at Line {result}");
                }
            ...
            {
                MyLog.Default.WriteLine($"SG.LCDInfo.LCDComponentsSummaryInfo: Caught Exception while loading config: {e.ToString()}");
            }
        }
        ...
        void UpdateInventories()
        {
            ...
            {
                MyLog.Default.WriteLine($"SG.LCDInfo.LCDComponentsSummaryInfo: Caught Exception while updating inventories: {e.ToString()}");
            }
        }
        ...
        void UpdateContents()
        {
            ...
            {
                MyLog.Default.WriteLine($"SG.LCDInfo.LCDComponentsSummaryInfo: Caught Exception while updating contents: {e.ToString()}");
            }
        }
        ...
        void DrawMainSprite(ref MySpriteDrawFrame frame, ref Vector2 position)
        {
            try
            {
                ...
                if (surfaceData.showSummary)
                {
                    ...
                    volume /= 1000;
                    SurfaceDrawer.DrawBar(ref frame, ref position, surfaceData, "Components", volume, current, Unit.Percent, false, true);
                    position += surfaceData.newLine;
                }
            ...
            {
                MyLog.Default.WriteLine($"SG.LCDInfo.LCDComponentsSummaryInfo: Caught Exception while DrawMainSprite: {e.ToString()}");
            }
        }
        ...
        void DrawAllKnownSprite(ref MySpriteDrawFrame frame, ref Vector2 position)
        {
            try
            {
                SurfaceDrawer.WriteTextSprite(ref frame, position, surfaceData, $"Id [Components]", TextAlignment.LEFT, surfaceData.surface.ScriptForegroundColor);
            ...
            {
                MyLog.Default.WriteLine($"SG.LCDInfo.LCDComponentsSummaryInfo: Caught Exception while DrawAllKnownSprite: {e.ToString()}");
            }
        }
        ...
        void DrawAllAvailableSprite(ref MySpriteDrawFrame frame, ref Vector2 position)
        {
            ...
            {
                MyLog.Default.WriteLine($"SG.LCDInfo.LCDComponentsSummaryInfo: Caught Exception while DrawAllAvailableSprite: {e.ToString()}");
            }
        }
